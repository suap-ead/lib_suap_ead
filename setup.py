...
setup(
    ...
    version='0.1.4',
    download_url='https://github.com/suap-ead/lib_suap_ead/releases/tag/0.1.4',
    url='https://github.com/suap-ead/lib_suap_ead',
    keywords=['SUAP', 'EAD', 'complemento', 'JWT', 'Django', 'Auth', 'SSO', 'client', 'Theme', ],
    install_requires=['PyJWT==1.7.1', 'django==3.0.7', 'djangorestframework==3.11.0', 'sc4py==0.1.1', 'sc4net==0.1.2'],
    classifiers=[
